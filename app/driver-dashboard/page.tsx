...
import { Truck, MapPin, Clock, Phone, AlertTriangle, Plus, Trash2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 py-3 sm:py-6 lg:py-8">
        ...
        {/* Accident Reports */}
        <div>
          <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">Your Accident Reports</h2>
          {loading ? (
